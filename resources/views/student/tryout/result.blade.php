    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 text-white shadow-lg mb-8">
            <div class="text-center">
                ...
                <p class="text-blue-200 text-sm mt-1">{{ $tryout->code }}</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border-2 border-green-200 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-4xl font-bold text-green-600">{{ $correctAnswers }}</span>
                </div>
                <p class="text-sm font-semibold text-gray-600">Jawaban Benar</p>
                <p class="text-xs text-gray-500 mt-1">{{ number_format(($correctAnswers / $totalQuestions) * 100, 1) }}% dari total soal</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border-2 border-red-200 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-4xl font-bold text-red-600">{{ $wrongAnswers }}</span>
                </div>
                <p class="text-sm font-semibold text-gray-600">Jawaban Salah</p>
                <p class="text-xs text-gray-500 mt-1">{{ number_format(($wrongAnswers / $totalQuestions) * 100, 1) }}% dari total soal</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border-2 border-gray-200 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-4xl font-bold text-gray-600">{{ $unanswered }}</span>
                </div>
                <p class="text-sm font-semibold text-gray-600">Tidak Dijawab</p>
                <p class="text-xs text-gray-500 mt-1">{{ number_format(($unanswered / $totalQuestions) * 100, 1) }}% dari total soal</p>
            </div>
