    ...
    <div class="bg-gradient-to-r from-red-600 to-red-700 rounded-xl p-6 text-white shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-red-100 mb-3">{{ $tryout->code }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <div class="flex items-start mb-4">
                                <div class="flex-shrink-0 w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center mr-4">
                                    <span class="text-lg font-bold text-red-600">{{ $question->question_number }}</span>
                                </div>
                                <div class="flex-1">
                            ...
                            @if($question->explanation)
                                <div class="ml-14 mt-4 p-4 bg-red-50 rounded-lg border border-red-200">
                                    ...
                                    <p class="text-sm text-red-800">{{ $question->explanation }}</p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="flex-shrink-0 ml-4 flex space-x-2">
                            ...
                            <div class="relative group">
                                <a href="{{ route('admin.question.edit', [$tryout->id, $question->id]) }}" 
                            ...
                            <!-- Hapus -->
                            <form action="{{ route('admin.question.destroy', [$tryout->id, $question->id]) }}" method="POST" class="relative group">
                                @csrf
                                @method('DELETE')
                                <button type="submit" 
