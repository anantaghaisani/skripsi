    ...
    <div class="bg-gradient-to-r from-red-600 to-red-700 rounded-xl p-6 text-white shadow-lg">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-red-100 mb-4">{{ $tryout->code }}</p>
                            ...
                            @foreach($completedStudents as $student)
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                ...
                                                @else
                                                    <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode($student->name) }}&background=DC2626&color=fff" alt="">
                                                @endif
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('admin.tryout.result', [$tryout->id, $student->id]) }}" 
