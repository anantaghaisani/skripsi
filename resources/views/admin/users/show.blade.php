                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200 text-left space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">
                                    @if($user->created_at)
                                        {{ \Carbon\Carbon::parse($user->created_at)->locale('id')->isoFormat('D MMM YYYY') }}
                                    @else
                                        -
                                    @endif
                                </p>
                            ...
                            <div class="flex items-center justify-between p-3 border-b last:border-b-0 hover:bg-gray-50 transition">
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        @if($tryout->pivot->finished_at)
                                            {{ \Carbon\Carbon::parse($tryout->pivot->finished_at)->locale('id')->isoFormat('D MMM YYYY, HH:mm') }}
                                        @else
                                            -
                                        @endif
                                    </p>
