...
<?php $__env->startSection('page-title', 'Kelola Modul'); ?>
...
<div class="p-8">
    ...
    <form method="GET" class="mb-6 flex items-center gap-4">
            ...
            <select name="creator_id"
                ...
                <?php $__currentLoopData = $creators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $creator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($creator->id); ?>"
                        <?php echo e(request('creator_id') == $creator->id ? 'selected' : ''); ?>>
        ...
        <!-- Add Module Button -->
        <a href="<?php echo e(route('admin.module.create')); ?>"
           class="h-12 px-6
    ...
    <div class="mb-6">
        <div class="flex bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <!-- Tab: Semua -->
            <a href="<?php echo e(route('admin.module.index', request()->except('is_active'))); ?>"
               class="flex-1 py-4 px-6 text-center text-sm transition
               <?php echo e(!request()->has('is_active')
            ...
            <!-- Tab: Aktif -->
            <a href="<?php echo e(route('admin.module.index', array_merge(request()->except('is_active'), ['is_active' => '1']))); ?>"
               class="flex-1 py-4 px-6 text-center text-sm transition
            ...
            <!-- Tab: Non Aktif -->
            <a href="<?php echo e(route('admin.module.index', array_merge(request()->except('is_active'), ['is_active' => '0']))); ?>"
               class="flex-1 py-4 px-6 text-center text-sm transition
    ...
    <?php if($modules->isEmpty()): ?>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p class="text-gray-600 mb-6">Mulai tambahkan modul pembelajaran</p>
            <a href="<?php echo e(route('admin.module.create')); ?>" 
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900"><?php echo e($module->title); ?></div>
                                            <div class="text-xs text-gray-500 mt-1"><?php echo e($module->file_type); ?> • <?php echo e(number_format($module->file_size / 1024 / 1024, 2)); ?> MB</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                                            <span class="text-xs font-semibold text-gray-600"><?php echo e(substr($module->creator->name, 0, 2)); ?></span>
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($module->creator->name); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e(ucfirst($module->creator->role)); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-wrap gap-1">
                                        <?php $__currentLoopData = $module->classes->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-purple-100 text-purple-800">
                                                <?php echo e($class->grade_level); ?> <?php echo e($class->class_number); ?>

                                            </span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($module->classes->count() > 2): ?>
                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-gray-100 text-gray-600">
                                                +<?php echo e($module->classes->count() - 2); ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <div class="relative group">
                                            <a href="<?php echo e(route('admin.module.show', $module->id)); ?>" 
                                        ...
                                        <!-- Edit -->
                                        <div class="relative group">
                                            <a href="<?php echo e(route('admin.module.edit', $module->id)); ?>" 
                                        ...
                                        <!-- Toggle Status -->
                                        <form action="<?php echo e(route('admin.module.toggle-status', $module->id)); ?>" method="POST" class="relative group">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" 
                                                    class="inline-flex items-center justify-center w-9 h-9 <?php echo e($module->is_active ? 'bg-gray-500 hover:bg-gray-600' : 'bg-green-500 hover:bg-green-600'); ?> text-white rounded-lg transition">
                                                <?php if($module->is_active): ?>
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-900 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition pointer-events-none">
                                                <?php echo e($module->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>
                                        ...
                                        <!-- Hapus -->
                                        <form action="<?php echo e(route('admin.module.destroy', $module->id)); ?>" method="POST" class="relative group">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fayat\tryout-app\resources\views/admin/module/index.blade.php ENDPATH**/ ?>