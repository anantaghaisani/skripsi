...
<?php $__env->startSection('title', 'Kelola Tryout'); ?>
<?php $__env->startSection('page-title', 'Kelola Tryout'); ?>
...
<div class="p-8 space-y-6">
    ...
    <div class="flex items-center gap-4">
            ...
            <form method="GET" id="filterForm">
                <select name="creator_id" 
                    ...
                    <?php $__currentLoopData = $creators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $creator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($creator->id); ?>" <?php echo e(request('creator_id') == $creator->id ? 'selected' : ''); ?>>
        ...
        <!-- Create Button -->
        <a href="<?php echo e(route('admin.tryout.create')); ?>" 
           class="h-12 px-6
    ...
    <?php else: ?>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $tryouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tryout): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900"><?php echo e($tryout->title); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($tryout->code); ?></div>
                                            <div class="text-xs text-gray-500 mt-1"><?php echo e($tryout->total_questions); ?> soal • <?php echo e($tryout->duration_minutes); ?> menit</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <?php if($tryout->creator): ?>
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                                                <span class="text-xs font-semibold text-gray-600"><?php echo e(substr($tryout->creator->name, 0, 2)); ?></span>
                                            </div>
                                            <div class="ml-3">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($tryout->creator->name); ?></div>
                                                <div class="text-xs text-gray-500"><?php echo e(ucfirst($tryout->creator->role)); ?></div>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-mono font-bold bg-red-100 text-red-800">
                                        <?php echo e($tryout->token); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-wrap gap-1">
                                        <?php $__currentLoopData = $tryout->classes->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-purple-100 text-purple-800">
                                                <?php echo e($class->grade_level); ?> <?php echo e($class->class_number); ?><?php echo e($class->name); ?>

                                            </span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($tryout->classes->count() > 2): ?>
                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-gray-100 text-gray-600">
                                                +<?php echo e($tryout->classes->count() - 2); ?>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">
                                    <div><?php echo e($tryout->start_date->format('d M Y')); ?></div>
                                    <div class="text-xs text-gray-400">s/d <?php echo e($tryout->end_date->format('d M Y')); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <!-- Monitor -->
                                        <div class="relative group">
                                            <a href="<?php echo e(route('admin.tryout.monitor', $tryout->id)); ?>" 
                                        ...
                                        <!-- Edit -->
                                        <div class="relative group">
                                            <a href="<?php echo e(route('admin.tryout.edit', $tryout->id)); ?>" 
                                        ...
                                        <!-- Hapus -->
                                        <form action="<?php echo e(route('admin.tryout.destroy', $tryout->id)); ?>" method="POST" class="relative group">
                                            <?php echo csrf_field(); ?>
            ...
            <!-- Pagination -->
            <?php if($tryouts->hasPages()): ?>
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <?php echo e($tryouts->links()); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fayat\tryout-app\resources\views/admin/tryout/index.blade.php ENDPATH**/ ?>