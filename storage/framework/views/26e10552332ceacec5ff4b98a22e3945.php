...
<div class="p-8 space-y-6">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-6 text-white shadow-lg">
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="text-blue-100 mb-4"><?php echo e($tryout->code); ?></p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-xs text-gray-500 mt-2"><?php echo e(number_format($stats['completion_rate'], 1)); ?>% completion rate</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-yellow-600"><?php echo e(number_format($stats['average_score'] ?? 0, 1)); ?></h3>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $completedStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                ...
                                                <?php else: ?>
                                                    <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($student->name)); ?>&background=184E83&color=fff" alt="">
                                                <?php endif; ?>
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span class="text-2xl font-bold text-green-600"><?php echo e(number_format($student->pivot->score, 1)); ?></span>
                                            <span class="ml-1 text-sm text-gray-500">/100</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e($student->pivot->finished_at ? \Carbon\Carbon::parse($student->pivot->finished_at)->format('d M Y, H:i') : '-'); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="<?php echo e(route('tentor.tryout.result', [$tryout->id, $student->id])); ?>" 
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('tentor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fayat\tryout-app\resources\views/tentor/tryout/monitor.blade.php ENDPATH**/ ?>