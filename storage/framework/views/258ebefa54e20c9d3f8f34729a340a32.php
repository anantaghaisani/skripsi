    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="text-center mb-8">
                <img src="<?php echo e(asset('images/logo_hmc.png')); ?>" alt="HM Logo" class="h-16 mx-auto mb-4">
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-600">
                &copy; <?php echo e(date('Y')); ?> Hakuna Matata Course. All rights reserved.
            </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\fayat\tryout-app\resources\views/auth/login.blade.php ENDPATH**/ ?>