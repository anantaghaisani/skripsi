...
<?php $__env->startSection('title', 'Detail Modul - ' . $module->title); ?>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="flex gap-4">
                    <?php if($module->file_type === 'pdf' && $module->file_path): ?>
                        <a href="<?php echo e(asset('storage/' . $module->file_path)); ?>" 
                           target="_blank"
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 ml-7"><?php echo e(ucfirst($module->creator->role)); ?></p>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t space-y-2">
                    ...
                    <form action="<?php echo e(route('admin.module.toggle-status', $module->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
                                class="w-full inline-flex items-center justify-center px-4 py-2 <?php echo e($module->is_active ? 'bg-gray-500 hover:bg-gray-600' : 'bg-green-500 hover:bg-green-600'); ?> text-white font-semibold rounded-lg transition">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <?php if($module->is_active): ?>
                    ...
                    <form action="<?php echo e(route('admin.module.destroy', $module->id)); ?>" 
                          method="POST"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__empty_1 = true; $__currentLoopData = $module->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fayat\tryout-app\resources\views/admin/module/show.blade.php ENDPATH**/ ?>