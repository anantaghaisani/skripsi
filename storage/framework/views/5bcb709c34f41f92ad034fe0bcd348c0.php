...
<?php $__env->startSection('title', 'Kelola Tryout - Hakuna Matata Course'); ?>
...
<div class="p-8 space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex-1 relative">
            ...
            <input type="text" 
                   id="searchInput"
                   placeholder="Cari berdasarkan nama, kelas, atau tanggal tryout..."
        ...
        <!-- Create Button -->
        <a href="<?php echo e(route('tentor.tryout.create')); ?>" 
           class="inline-flex items-center px-6 py-3 bg-hm-blue hover:bg-blue-700 text-white font-semibold rounded-lg transition shadow-sm whitespace-nowrap">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <!-- Monitor -->
                                        <div class="relative group">
                                            <a href="<?php echo e(route('tentor.tryout.monitor', $tryout->id)); ?>" 
                                        ...
                                        <!-- Edit -->
                                        <div class="relative group">
                                            <a href="<?php echo e(route('tentor.tryout.edit', $tryout->id)); ?>" 
                                        ...
                                        <!-- Hapus -->
                                        <form action="<?php echo e(route('tentor.tryout.destroy', $tryout->id)); ?>" method="POST" class="relative group">
                                            <?php echo csrf_field(); ?>
...
function searchTryouts() {
    ...
    rows.forEach(row => {
        ...
        const tokenCell = row.cells[1]?.textContent.toLowerCase() || '';
        const classCell = row.cells[2]?.textContent.toLowerCase() || '';
        const dateCell = row.cells[3]?.textContent.toLowerCase() || '';
        
        // Combine all searchable text
        const searchText = titleCell + ' ' + tokenCell + ' ' + classCell + ' ' + dateCell;
...
<?php echo $__env->make('tentor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fayat\tryout-app\resources\views/tentor/tryout/index.blade.php ENDPATH**/ ?>