...
<?php $__env->startSection('title', 'Input Token - Hakuna Matata Course'); ?>
...
<div class="p-8">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 text-white shadow-lg mb-8">
        <div class="flex items-center mb-4">
            ...
            <div>
                <h2 class="text-2xl font-bold"><?php echo e($tryout->title); ?></h2>
                <p class="text-blue-100"><?php echo e($tryout->code); ?></p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-white/20">
            ...
            <div>
                ...
                <p class="text-2xl font-bold"><?php echo e($tryout->duration_minutes); ?> menit</p>
            </div>
            <div>
                <p class="text-blue-100 text-sm">Periode</p>
                <p class="text-sm font-semibold"><?php echo e($tryout->start_date->format('d M')); ?> - <?php echo e($tryout->end_date->format('d M Y')); ?></p>
            </div>
        </div>
    </div>
    ...
    <?php else: ?>
        <!-- Token Input Form - Centered in Full Width -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                ...
                <form action="<?php echo e(route('tryout.start', $tryout->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               ...
                               name="token" 
                               maxlength="6"
                               class="w-full px-6 py-4 text-center text-2xl font-mono font-bold uppercase border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['token'];
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fayat\tryout-app\resources\views/student/tryout/token-input.blade.php ENDPATH**/ ?>