...
<?php $__env->startSection('page-title', 'Daftar Modul'); ?>
...
<div class="p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <form method="GET" class="mb-6 flex items-center gap-4">
            ...
            <!-- Add Module Button -->
            <a href="<?php echo e(route('tentor.modules.create')); ?>"
               class="h-12 px-6
        ...
        <div class="mb-6">
            <div class="flex bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <!-- Tab: Semua -->
                <a href="<?php echo e(route('tentor.modules.index', request()->except('is_active'))); ?>"
                ...
                <!-- Tab: Aktif -->
                <a href="<?php echo e(route('tentor.modules.index', array_merge(request()->except('is_active'), ['is_active' => '1']))); ?>"
                   class="flex-1 py-4 px-6 text-center text-sm transition
                ...
                <!-- Tab: Non Aktif -->
                <a href="<?php echo e(route('tentor.modules.index', array_merge(request()->except('is_active'), ['is_active' => '0']))); ?>"
                   class="flex-1 py-4 px-6 text-center text-sm transition
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <div class="relative group">
                                                <a href="<?php echo e(route('tentor.modules.show', $module->id)); ?>" 
                                            ...
                                            <!-- Edit -->
                                            <div class="relative group">
                                                <a href="<?php echo e(route('tentor.modules.edit', $module->id)); ?>" 
                                            ...
                                            <!-- Toggle Status -->
                                            <form action="<?php echo e(route('tentor.modules.toggle-status', $module->id)); ?>" method="POST" class="relative group">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" 
                                            ...
                                            <!-- Hapus -->
                                            <form action="<?php echo e(route('tentor.modules.destroy', $module->id)); ?>" method="POST" class="relative group">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('tentor.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\fayat\tryout-app\resources\views/tentor/modules/index.blade.php ENDPATH**/ ?>