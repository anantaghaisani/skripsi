        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <img src="<?php echo e(asset('images/logo_hmc.png')); ?>" alt="HMC Logo" class="h-12 w-auto">
                    <div>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="px-6 py-2 bg-[#184E83] hover:bg-[#0F3A5F] text-white font-semibold rounded-full transition">
                        Login
                    </a>
                </div>
            ...
            <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4 space-y-3">
                ...
                <a href="<?php echo e(route('login')); ?>" class="block w-full text-center px-6 py-2 bg-[#184E83] hover:bg-[#0F3A5F] text-white font-semibold rounded-full transition">
                    Login
                </a>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative float-animation">
                    ...
                    <div class="max-w-md mx-auto">
                        <img src="<?php echo e(asset('images/logolengkapp.png')); ?>" 
        ...
        <div class="relative">
            ...
            >
                ...
                <div class="tentor-card flex-shrink-0 w-72 text-center snap-center">
                    <img src="<?php echo e(asset('images/Miss Al.JPG')); ?>" class="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-[#FFBF00] shadow-lg">
                ...
                <div class="tentor-card flex-shrink-0 w-72 text-center snap-center">
                    <img src="<?php echo e(asset('images/Bu Tutut.jpg')); ?>" class="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-[#FFBF00] shadow-lg">
                ...
                <div class="tentor-card flex-shrink-0 w-72 text-center snap-center">
                    <img src="<?php echo e(asset('images/Bu May.JPG')); ?>" class="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-[#FFBF00] shadow-lg">
                ...
                <div class="tentor-card flex-shrink-0 w-72 text-center snap-center">
                    <img src="<?php echo e(asset('images/Pak Eko.JPG')); ?>" class="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-[#FFBF00] shadow-lg">
                ...
                <div class="tentor-card flex-shrink-0 w-72 text-center snap-center">
                    <img src="<?php echo e(asset('images/Bu Ima.JPG')); ?>" class="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-[#FFBF00] shadow-lg">
                ...
                <div class="tentor-card flex-shrink-0 w-72 text-center snap-center">
                    <img src="<?php echo e(asset('images/Pak Rizal.JPG')); ?>" class="w-48 h-48 rounded-full mx-auto mb-4 object-cover border-4 border-[#FFBF00] shadow-lg">
    ...
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>
        ...
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                e.preventDefault();
                const target = doc<?php /**PATH C:\Users\fayat\tryout-app\resources\views/welcome.blade.php ENDPATH**/ ?>