...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_answers', function (Blueprint $table) {
            ...
            $table->foreignId('answer_id')->nullable()->constrained('answers')->onDelete('set null'); // Jawaban yang dipilih
            $table->enum('selected_option', ['A', 'B', 'C', 'D', 'E'])->nullable(); // Opsi yang dipilih
